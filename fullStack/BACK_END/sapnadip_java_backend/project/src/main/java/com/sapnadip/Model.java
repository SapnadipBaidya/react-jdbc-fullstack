...
protected String aging_bucket;
public Model(int sl_no,String business_code,String cust_number,String clear_date,String buisness_year,String doc_id,
		String posting_date,String due_in_date,String baseline_create_date,String cust_payment_terms,String total_open_amount) {
	super();
...
public Model(int sl_no,String business_code,String cust_number,String clear_date,String buisness_year,String doc_id,
		String posting_date,String document_create_date,String due_in_date,String invoice_currency,String document_type,String posting_id,
		String total_open_amount,String baseline_create_date,String cust_payment_terms,String invoice_id,String aging_bucket) {
	super();
	this.sl_no = sl_no;
	this.business_code = business_code;
	this.cust_number = cust_number;
...
public Model(int sl_no, String invoice_currency, String cust_payment_terms) {
	super();
	this.sl_no = sl_no;
	this.invoice_currency = invoice_currency;
	this.cust_payment_terms = cust_payment_terms;
...
public Model(String invoice_currency, String cust_payment_terms) {
	super();
	this.invoice_currency = invoice_currency;
	this.cust_payment_terms = cust_payment_terms;
}
...
public void setInvoice_id(String invoice_id) {
	...
	public Model(String business_code, String cust_number, String clear_date, String buisness_year, String doc_id,
	...
	public Model(int sl_no, String business_code, String cust_number, String clear_date, String buisness_year,
		String doc_id, String posting_date, String document_create_date, String due_in_date, String invoice_currency,
		String document_type, String posting_id, String total_open_amount, String baseline_create_date,
		String cust_payment_terms, String invoice_id) {
	super();
	this.sl_no = sl_no;
